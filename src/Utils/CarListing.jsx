    ...
    useEffect(() => {
        const fetchCars = async () => {
            try {
                ...
                const { data } = await axios.get(`http://localhost:8000/api/showCars/fetchCar?search=${search}&make=${make}&bodyType=${bodyType}&fuelType=${fuelType}&transmission=${transmission}&minPrice=${priceRange[0]}&maxPrice=${priceRange[1]}&sortBy=${sortBy}&page=${currPage}&limit=${limit}`, config);
